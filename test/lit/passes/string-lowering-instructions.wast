...
(module
  ...
  ;; CHECK:       (type $9 (func (param externref (ref $array16)) (result i32)))
  ...
  ;; CHECK:      (type $18 (func (param externref) (result externref)))

  ;; CHECK:      (type $19 (func (result externref)))

  ;; CHECK:      (type $20 (func (param externref externref) (result (ref extern))))

  ;; CHECK:      (type $21 (func (param externref (ref $array16)) (result i32)))

  ;; CHECK:      (type $22 (func (param externref i32 externref)))

  ;; CHECK:      (type $23 (func (param externref)))

  ;; CHECK:      (type $24 (func (param (ref null $array16) i32 i32) (result (ref extern))))

  ;; CHECK:      (type $25 (func (param i32) (result (ref extern))))

  ;; CHECK:      (type $26 (func (param externref (ref null $array16) i32) (result i32)))

  ;; CHECK:      (type $27 (func (param externref i32) (result i32)))

  ;; CHECK:      (type $28 (func (param externref i32 i32) (result (ref extern))))
  ...
  ;; CHECK:      (import "colliding" "name" (func $fromCodePoint (type $15)))
  (import "colliding" "name" (func $fromCodePoint))


  ;; CHECK:      (import "wasm:js-string" "fromCharCodeArray" (func $fromCharCodeArray (type $24) (param (ref null $array16) i32 i32) (result (ref extern))))

  ;; CHECK:      (import "wasm:js-string" "fromCodePoint" (func $fromCodePoint_19 (type $25) (param i32) (result (ref extern))))

  ;; CHECK:      (import "wasm:js-string" "concat" (func $concat (type $20) (param externref externref) (result (ref extern))))

  ;; CHECK:      (import "wasm:js-string" "intoCharCodeArray" (func $intoCharCodeArray (type $26) (param externref (ref null $array16) i32) (result i32)))

  ;; CHECK:      (import "wasm:js-string" "equals" (func $equals (type $17) (param externref externref) (result i32)))

  ;; CHECK:      (import "wasm:js-string" "test" (func $test (type $16) (param externref) (result i32)))
  ...
  ;; CHECK:      (import "wasm:js-string" "charCodeAt" (func $charCodeAt (type $27) (param externref i32) (result i32)))

  ;; CHECK:      (import "wasm:js-string" "substring" (func $substring (type $28) (param externref i32 i32) (result (ref extern))))
  ...
  ;; CHECK:      (func $string.from_code_point (type $19) (result externref)
  ...
  ;; CHECK:      (func $string.concat (type $20) (param $0 externref) (param $1 externref) (result (ref extern))
  ...
  ;; CHECK:      (func $string.encode (type $21) (param $ref externref) (param $array16 (ref $array16)) (result i32)
  ...
  ;; CHECK:      (func $string.eq (type $17) (param $a externref) (param $b externref) (result i32)
  ...
  ;; CHECK:      (func $string.compare (type $17) (param $a externref) (param $b externref) (result i32)
  ...
  ;; CHECK:      (func $string.slice (type $18) (param $ref externref) (result externref)
  ...
  ;; CHECK:      (func $if.string (type $18) (param $ref externref) (result externref)
  ...
  ;; CHECK:      (func $if.string.flip (type $18) (param $ref externref) (result externref)
  ;; CHECK-NEXT:  (if (result externref)
  ;; CHECK-NEXT:   (i32.const 0)
  ;; CHECK-NEXT:   (then
  ;; CHECK-NEXT:    (local.get $ref)
  ...
  ;; CHECK:      (func $exported-string-returner (type $19) (result externref)
  ...
  ;; CHECK:      (func $exported-string-receiver (type $22) (param $x externref) (param $y i32) (param $z externref)
  ;; CHECK-NEXT:  (drop
  ...
  ;; CHECK:      (func $use-struct-of-array (type $15)
  ...
  ;; CHECK:      (func $struct-of-string (type $15)
  ;; CHECK-NEXT:  (drop
  ...
  ;; CHECK:      (func $call-param-null (type $23) (param $str externref)
