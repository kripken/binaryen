...
;; RUN: foreach %s %t wasm-opt --optimize-instructions --traps-never-happen -all --nominal -S -o - | filecheck %s --check-prefix TNH
;; RUN: foreach %s %t wasm-opt --optimize-instructions                      -all --nominal -S -o - | filecheck %s --check-prefix NO_TNH
...
(module
  ...
  ;; TNH:      (type $eqref_=>_i32 (func_subtype (param eqref) (result i32) func))

  ;; TNH:      (type $anyref_=>_i32 (func_subtype (param anyref) (result i32) func))

  ;; TNH:      (type $eqref_eqref_=>_i32 (func_subtype (param eqref eqref) (result i32) func))

  ;; TNH:      (type $eqref_eqref_=>_none (func_subtype (param eqref eqref) func))
  ...
  ;; TNH-NEXT:  )
  ;; TNH-NEXT: )
  ;; NO_TNH:      (type $eqref_=>_i32 (func_subtype (param eqref) (result i32) func))

  ;; NO_TNH:      (type $anyref_=>_i32 (func_subtype (param anyref) (result i32) func))

  ;; NO_TNH:      (type $eqref_eqref_=>_i32 (func_subtype (param eqref eqref) (result i32) func))

  ;; NO_TNH:      (type $eqref_eqref_=>_none (func_subtype (param eqref eqref) func))

  ;; NO_TNH:      (elem declare func $ref.eq-no)
