...
;; RUN: wasm-opt %s -all --disable-string-builtins --string-lowering-magic-imports --remove-unused-module-elements -S -o - | filecheck %s

;; Text round tripping
;; RUN: wasm-opt %s -all --disable-string-builtins --string-lowering-magic-imports --remove-unused-module-elements -S -o - | wasm-opt -all -S -o - | filecheck %s

;; Binary round tripping
;; RUN: wasm-opt %s -all --disable-string-builtins --string-lowering-magic-imports --remove-unused-module-elements --roundtrip -S -o - | filecheck %s --check-prefix=RTRIP
